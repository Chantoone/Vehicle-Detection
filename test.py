...
# Vị trí đề xuất cho các line
lines_suggested = [
    [565, 258, 893, 180],  # Hướng A (phía trên)
    [604, 367, 750, 1015],  # Hướng B (bên trái)
    [1180, 230, 1560, 456]  # Hướng C (bên phải)
]

# Vùng phát hiện hàng đợi (queue zones): x1, y1, x2, y2
queue_zones = [
    [(600, 100, 800, 200)],  # Hướng A
    [(200, 350, 400, 450)],  # Hướng B
    [(900, 350, 1100, 450)]  # Hướng C
]
...
def mouseClick(event, x, y, flags, params):
    global click_points, lines
    if event == cv2.EVENT_LBUTTONDOWN:
        if len(click_points) < max_directions * 2:
...
if not lines and lines_suggested: lines = lines_suggested
